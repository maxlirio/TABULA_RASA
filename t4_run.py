...
WIKI_MB = sys.argv[1] if len(sys.argv) > 1 else "40"   # less wiki: warm-start already gives fluency
...
append("data/stories2/chat.txt", 10)         # DIVERSE real fables -> generative storytelling (weaving)
append("data/solving/chat.txt", 4)           # generative problem-solving (obstacle -> fitting options)
